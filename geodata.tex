...
\begin{document}
	...
	\todo[size={{\scriptsize}}]{indexed dataset, one indexed one not, not-indexed datasets}
	...
	range from $k\textsubscript{1}$ to $k\textsubscript{2}$.
	\\
	...
	\todo[size={{\scriptsize}}]{more info for (multilevel) grid files}
	The \term{grid file} \citep{Nievergelt} is a contribution to the development of balanced multikey file structures. 
	\\
