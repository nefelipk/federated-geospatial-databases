...
\begin{document}
	...
	Let us start with techniques for performing a spatial join without using 
	external memory. That is no data is written to external memory, only read 
	once if necessary. 
	\\
...
During the filtering stage, a spatial join is performed on approximations of the objects. 
\\

\todo[size={{\scriptsize}}]{more info for R-trees and B-trees}
