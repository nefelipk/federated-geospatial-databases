...
\\
	...
	B\textsuperscript{+}-tree \citep{Comer} (see also B-trees \citep{Bayer}) 
	in multidimensional space. There is no special ordering of objects in space 
	...
	those results really fulfill the join condition.n 
	\\
