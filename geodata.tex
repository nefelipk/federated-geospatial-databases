...
\begin{document}
	...
	spatial objects and $r$ be a rectilinear rectangle. The window query 
	searches all objects $a \in A$ with $a \cap r \neq \emptyset$.
	\\
...
\todo[size={{\scriptsize}}]{more info for R-trees, B-trees, quad trees, multilevel grid files, kd trees}
